...
class XcbLoader
{
  public:
    struct FunctionTable
    {
        ...
        decltype(xcb_map_window_checked)*       map_window_checked;
        ...
        decltype(xcb_send_event_checked)*       send_event_checked;
        decltype(xcb_setup_roots_iterator)*     setup_roots_iterator;
        decltype(xcb_unmap_window)*             unmap_window;
        decltype(xcb_unmap_window_checked)*     unmap_window_checked;
