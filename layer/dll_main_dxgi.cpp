...
EXTERN_C HRESULT WINAPI CreateDXGIFactory2(UINT Flags, REFIID riid, _COM_Outptr_ void** ppFactory)
{
    if ((dispatch_table != nullptr) && (dispatch_table->create_dxgi_factory2_func != nullptr))
    {
        return dispatch_table->create_dxgi_factory2_func(Flags, riid, ppFactory);
    }
